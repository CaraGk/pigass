...
/**
 * App\Entity\EvalCriteria
 *
 * @ORM\Table(name="eval_criteria")
 * @ORM\Entity(repositoryClass="App\Repository\EvalCriteriaRepository")
 */
class EvalCriteria
{
    /**
     ...
     * Set eval_form
     *
     * @param App\Entity\EvalForm $eval_form
     */
    public function setEvalForm(\App\Entity\EvalForm $eval_form)
    {
