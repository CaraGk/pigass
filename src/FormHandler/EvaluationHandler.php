...
class EvaluationHandler
{
  ...
  public function __construct(Form $form, Request $request, EntityManager $em, \App\Entity\Placement $placement, array $eval_forms, $moderate)
  {
    $this->form      = $form;
  ...
  public function process()
  {
    ...
    private function setEvalItem($criteria, $value)
    {
        if ($criteria->isRequired() == true or $value != null) {
            ...
            $eval_criteria->setStructure($this->placement->getRepartition()->getDepartment()->getHospital()->getStructure());
