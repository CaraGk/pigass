...
class SimulPeriodHandler
{
  ...
  public function __construct(Form $form, Request $request, EntityManager $em, \App\Entity\Period $period)
  {
    $this->form    = $form;
  ...
  public function onSuccess(SimulPeriod $simul_period)
  {
      ...
      $simul_period->setStructure($period->getStructure());
