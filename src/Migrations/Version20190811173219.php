 ...
 */
final class Version20190811173219 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wish CHANGE simstudent simperson INT NOT NULL');
        $this->addSql('ALTER TABLE wish ADD CONSTRAINT FK_D7D174C98FFC0DDE FOREIGN KEY (simperson) REFERENCES simulation (id)');
        $this->addSql('CREATE INDEX IDX_D7D174C98FFC0DDE ON wish (simperson)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wish DROP FOREIGN KEY FK_D7D174C98FFC0DDE');
        $this->addSql('DROP INDEX IDX_D7D174C98FFC0DDE ON wish');
        $this->addSql('ALTER TABLE wish CHANGE simperson simstudent INT NOT NULL');
