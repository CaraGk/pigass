 ...
 */
final class Version20220618121332 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE accreditation CHANGE department_id department_id INT DEFAULT NULL, CHANGE sector_id sector_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE structure_id structure_id INT DEFAULT NULL, CHANGE end end DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE member_info ADD CONSTRAINT FK_37011D0B9622182E FOREIGN KEY (memberquestion_id) REFERENCES member_question (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE fee CHANGE structure_id structure_id INT DEFAULT NULL');
